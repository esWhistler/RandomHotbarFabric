...
public class ConfigScreen {
    ...
    public static Screen buildScreen(Screen parent) {
        ...
        ConfigCategory general = builder.getOrCreateCategory(new TranslatableText("config." + MOD_ID + ".category"));
        ...
        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar2"), ModConfigs.HOTBAR[2])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[2] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar3"), ModConfigs.HOTBAR[3])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[3] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar4"), ModConfigs.HOTBAR[4])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[4] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar5"), ModConfigs.HOTBAR[5])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[5] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar6"), ModConfigs.HOTBAR[6])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[6] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar7"), ModConfigs.HOTBAR[7])
                .setDefaultValue(0.11)
                .setSaveConsumer(newValue -> ModConfigs.HOTBAR[7] = newValue)
                .build());

        general.addEntry(entryBuilder.startDoubleField(new TranslatableText("config." + MOD_ID + ".variable.hotbar8"), ModConfigs.HOTBAR[8])
                .setDefaultValue(0.11)
